...
include ('config.php');
  ...
  $sql = "SELECT firstname, student_id, lastname, course, email, phone,img_url FROM student_user WHERE username = '" . $_SESSION['username'] . "'";
	...
	<div class="container-fluid main-container">
		<div class="col-md-2 sidebar">
			<ul class="nav nav-pills nav-stacked">
				...
				<li style="margin-top: 20px" class="active"><a href="studentdashboard.php" style="background-color: deepskyblue;color: white">Home</a></li>
