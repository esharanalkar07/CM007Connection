...
if(isset($_POST['upload']))
{
        ...
        && in_array($extension, $allowedExts))
    {
        ...
        else
        {
            ...
            $update="update teacher_user set img_url='$url' where username='$user'";
            ...
            if($db->query($update)){
                ...
                echo '</div>';
                header('refresh:2;url=teacherdashboard.php');
            }
            else{
...
<div class="container-fluid main-container">
    <div class="col-md-2 sidebar">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li ><a href="teacherpicupload.php"class="active" style="background-color: deepskyblue;color: white">Change Photo</a></li>
        ...
        <div style="height: 400px"class="panel panel-default">
            ...
            <div class="panel-body">
                <div style="margin-top:100px; border-style: groove;background-color: lightskyblue ;padding-top: 30px;margin-left: 300px;width: 300px;padding-left: 30px" id="profileinfo"> <strong><font size="3"; color="black">
                            <form action="teacherpicupload.php" method="post" enctype="multipart/form-data">
                                Upload a Photo:
