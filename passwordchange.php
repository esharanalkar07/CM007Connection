...
$check="select * from student_user where username='$user' and password='$old'";
...
if(isset($_POST['submit'])){
    ...
    if($count>0){
        ...
        $update="update student_user set password='$new' where username='$user'";
        if($db->query($update)){
...
<div class="container-fluid main-container">
    <div class="col-md-2 sidebar">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li><a href="passwordchange.php"class="active"style="background-color: deepskyblue;color: white"    >Change Password</a></li>
