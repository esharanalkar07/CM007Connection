...
<div class="container-fluid main-container">
    <div class="col-md-2 sidebar">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li><a href="viewteacherassignment.php" style="background-color: deepskyblue;color: white" class="active">My Assignments</a></li>
            ...
            <div class="panel-body">
                ...
                <div id="body">
                    <table width="80%" border="1" >
                        ...
                        $sql="SELECT * FROM teacher_assignment where teacher_id='$teacher_id'";
                        ...
                        while($row=mysqli_fetch_array($result_set))
                        {
                            ...
                            <tr>
                                ...
                                <td><a href="teacher_assignments/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
                            </tr>
                            <?php
                        }
                        ?>
